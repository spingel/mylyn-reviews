...
public class SourceRepositoryMappingPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public boolean performOk() {
		try {
			...
			ErrorDialog.openError(getShell(), "", "Error while saving FishEye mapping configuration", new Status(
					IStatus.ERROR, AtlassianTeamUiPlugin.PLUGIN_ID, e.getMessage(), e));
			return false;
		}
